...
deposits = (
    ...
    BonusTimeDeposit("Бонусный 2", interest_rate=5, period_limit=(6, 18), sum_limit=(1000, 100000), bonus=dict(percent=5, sum=2000)),
    CompoundTimeDeposit("С капитализацией", interest_rate=5, period_limit=(6, 18), sum_limit=(1000, 100000))
)
```  
